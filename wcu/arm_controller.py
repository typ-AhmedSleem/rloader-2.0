...
class ArmControllerWindow(QtWidgets.QWidget):
    def __init__(self, handle_arm_cmd):
        ...
        lbl_joint1 = QtWidgets.QLabel(parent=self, text=f'Joint 1:\t Angle= {self.joints[Joints.Joint_1[0]]}')
        ...
        btn_sm1_p.clicked.connect(lambda: handle_arm_cmd(Joints.Joint_1, self.joints[Joints.Joint_1[0]], Operation.INC))
        ...
        btn_sm1_n.clicked.connect(lambda: handle_arm_cmd(Joints.Joint_1, self.joints[Joints.Joint_1[0]], Operation.DEC))
        ...
        lbl_joint2 = QtWidgets.QLabel(parent=self, text=f'Joint 2:\t Angle= {self.joints[Joints.Joint_2[0]]}')
        ...
        btn_sm2_p.clicked.connect(lambda: handle_arm_cmd(Joints.Joint_2, self.joints[Joints.Joint_2[0]], Operation.INC))
        ...
        btn_sm2_n.clicked.connect(lambda: handle_arm_cmd(Joints.Joint_2, self.joints[Joints.Joint_2[0]], Operation.DEC))
        ...
        lbl_joint3 = QtWidgets.QLabel(parent=self, text=f'Joint 3:\t Angle= {self.joints[Joints.Joint_3[0]]}')
        ...
        btn_sm3_p.clicked.connect(lambda: handle_arm_cmd(Joints.Joint_3, self.joints[Joints.Joint_3[0]], Operation.INC))
        ...
        btn_sm3_n.clicked.connect(lambda: handle_arm_cmd(Joints.Joint_3, self.joints[Joints.Joint_3[0]], Operation.DEC))
        ...
        lbl_joint4 = QtWidgets.QLabel(parent=self, text=f'Joint 4:\t Angle= {self.joints[Joints.Joint_4[0]]}')
        ...
        btn_sm4_p.clicked.connect(lambda: handle_arm_cmd(Joints.Joint_4, self.joints[Joints.Joint_4[0]], Operation.INC))
        ...
        btn_sm4_n.clicked.connect(lambda: handle_arm_cmd(Joints.Joint_4, self.joints[Joints.Joint_4[0]], Operation.DEC))
        ...
        lbl_joint5 = QtWidgets.QLabel(parent=self, text=f'Joint 5:\t Angle= {self.joints[Joints.Joint_5[0]]}')
        ...
        btn_sm5_p.clicked.connect(lambda: handle_arm_cmd(Joints.Joint_5, self.joints[Joints.Joint_5[0]], Operation.INC))
        ...
        btn_sm5_n.clicked.connect(lambda: handle_arm_cmd(Joints.Joint_5, self.joints[Joints.Joint_5[0]], Operation.DEC))
        ...
        lbl_joint6 = QtWidgets.QLabel(parent=self, text=f'Joint 6:\t Angle= {self.joints[Joints.Joint_6[0]]}')
        ...
        btn_sm6_p.clicked.connect(lambda: handle_arm_cmd(Joints.Joint_6, self.joints[Joints.Joint_6[0]], Operation.INC))
        ...
        btn_sm6_n.clicked.connect(lambda: handle_arm_cmd(Joints.Joint_6, self.joints[Joints.Joint_6[0]], Operation.DEC))
        ...
        self.lbls = {
            ...
            Joints.Joint_6[0]: lbl_joint6}

    def ujr(self, jid: str, na: int):
        self.joints[jid] = na
        self.lbls[jid].setText(f"Joint {jid.split('_')[1]}:\t Angle={self.joints[jid]}")
